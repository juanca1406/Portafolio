  ...
  const portafolio = [
    {
      ...
      categoria: "web",
      titulo: "Sistemas Pos",
      descripcion: "AxiomaPos es un sistema POS desarrollado de manera colaborativa junto con mi equipo. Este proyecto tiene como objetivo optimizar la gestión de ventas e inventarios en restaurantes, tiendas y hoteles. Incluye funcionalidades avanzadas como recomendaciones personalizadas mediante inteligencia artificial y una integración multiplataforma (web y Android).",
